      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <h5 class="box-title">ฟอร์มส่งข้อมูล Flex1</h3>
              <div class="row">
                <div class="col-md-4">
                    <a href="#"><img class="img-responsive pad" src="../dist/img/flex1.png" alt=""></a>
                </div>
                <div class="col-md-8">
          ...
          <!--<div class="box box-warning">-->
            ...
            <!-- /.box-header -->
            <!--<div class="box-body">-->
              <form role="form" method="POST" action="/lineoa/flex1send" >
                  @csrf
                ...
                <!-- select -->
                <div class="form-group">
                  <label>เลือกขนาด Size</label>
                  <select class="form-control" name="msg_size">
                ...
                <!-- textarea -->
                <div class="form-group">
                  <label>เนื้อหา/ข้อมูล</label>
                  <textarea name="msg_text" class="form-control" rows="3" placeholder="ข้อความ ..."></textarea>
                </div>

                <div class="form-group">
                  <label>ลิงก์รูปภาพ</label>
                  <input type="text" name="msg_picture" class="form-control" value="https://restful.tphcp.go.th/TPHCP-HEAD-NEWS.jpg">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group has-warning">
                          ...
                          <input type="text" name="msg_pw" class="form-control" id="inputWarning" value="800">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group has-warning">
                          <label class="control-label" for="inputWarning">ความยาว pixel</label>
                          <input type="text" name="msg_ph" class="form-control" id="inputWarning" value="450">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="msg_link" class="form-control" value="https://liff.line.me/1654103357-ed9Wkz9L">
                </div>
                <div class="form-group">
                  <label>หมายเหตุ</label>
                  <input type="text" name="msg_other" class="form-control" value="ด้วยความปรารถนาดีจาก รพร.ตะพานหิน">
                </div>
